...
SheriffClaw is a Python multi-service system that gates AI-agent actions behind deterministic policy, approvals, and
secrets isolation.
...
- Individual service binaries (e.g. `sheriff-gateway`, `sheriff-secrets`, `codex-mcp-host`).
